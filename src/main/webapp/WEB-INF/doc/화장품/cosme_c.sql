...
COMMENT ON COLUMN COSME.AGE is '추천 나이대';
...
VALUES(cosme_seq.nextval, '한율', '한율 어린쑥 수분진정 크림', 30, sysdate, 1, 1, '1', '2', '3', 4, '5');


commit;

SELECT cosmeno, brand, cosmename, age, rdate, masterno, cosme_cateno, cosme_file, cosme_file_saved, cosme_file_preview, cosme_file_size, cosme_youtube FROM cosme ORDER BY cosmeno ASC;
...
UPDATE cosme
SET cosmename='솔데스크', rdate=sysdate
WHERE cosmeno=2;
