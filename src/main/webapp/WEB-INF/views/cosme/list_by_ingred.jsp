    ...
    var listVisible = false;
      ...
      function getAllButtonsInDiv() {
          ...
          if (divElement) {
            ...
            xhr.open("POST", "/cosme/list_by_ingred.do", true);
...
<div id="buttondiv">
        <c:forEach items="${ingred_list}" var="ingred_list">
        <button class="btn_type" onclick="buttonchange(this)" value="${ingred_list.ingredno}" style="color: lightgray;">${ingred_list.ingredname}</button>
        </c:forEach>
  <!--라디오 버튼 (인기순 등)-->
</div>
