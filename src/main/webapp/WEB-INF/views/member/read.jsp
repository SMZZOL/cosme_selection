...
<c:import url="../menu/header.jsp" />
  ...
  <FORM name='frm' id='frm' method='POST' action='./update.do' class="">
    ...
    <div class="form-group"> <%-- 줄이 변경되지 않는 패턴 --%>
      ...
      <button style="margin-top:5px;" type='button' id="btn_checkID" onclick="checkID()" class="normal_button">중복확인</button>
    </div>  
    ...
    <div class="form-group"> <%-- 줄이 변경되지 않는 패턴 --%>
      ...
      <button style="margin-top:5px;" type="button" id="btn_DaumPostcode" onclick="DaumPostcode()" class="normal_button">우편번호 찾기</button>
    </div>  
...
<!-- ------------------------------ DAUM 우편번호 API 종료 ------------------------------ -->
    ...
    <div class="form_input">
      <button style="margin-top:5px;" type="button" id='btn_send' onclick="send()" class="normal_button">저장</button>
      <button style="margin-top:5px;" type="button" onclick="history.back()" class="normal_button">취소</button>
    </div>   
  </FORM>
  </DIV>
