...
<c:set var="masterno" value="${param.masterno }" /> <%-- // redirect parameter 적용 --%>
  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='./create.do" class="my-btn btn">새로운 공지사항 등록</button>
        <button type='button' onclick="location.href='./list_all'" class="my-btn btn">목록</button>
      </LI>
    </UL>
  </fieldset>
