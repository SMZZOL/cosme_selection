...
자유게시판
  ...
  <fieldset class="fieldset_basic">
    ...
    <button type="button" onclick="location.href='/fboard/list_all.do'" class="normal_button">목록형</button>
    <button type="button" onclick="location.href='/fboard/list_grid.do'" class="normal_button">앨범형</button>
     </div>
