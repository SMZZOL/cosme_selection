...
<c:import url="../menu/header.jsp" />
  ...
  <DIV class='bottom_menu'>
    <button type='button' onclick="location.href='./create.do'" class="normal_button">등록</button>
    <button type='button' onclick="location.reload();" class="normal_button">새로 고침</button>
  </DIV>
</DIV>
